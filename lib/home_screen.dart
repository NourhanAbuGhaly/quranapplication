...
import 'package:quranapplication/aya_of_the_day.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    var _size = MediaQuery.of(context).size * .22;
    ...
    //   _apiServices.getAyaOfDay().then((value) => data = value);
    return SafeArea(
      child: Scaffold(
          body: Column(
        children: [
              ...
              child: Column(
                children: [
                  FutureBuilder<AyaOfTheDay>(
                    future: _apiServices.getAyaOfDay(),
